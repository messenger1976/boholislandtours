...
<head>
    ...
    <title><?php echo isset($title) ? html_escape($title) : 'Create Account'; ?> - Bohol Island Tours</title>
    ...
    <style>
        ...
        *::after {
        ...
        .control.has-toggle .form-control {
        ...
        @media (min-width: 640px) {
            ...
            .login-intro {
                padding: 1.6rem 1.75rem 0.4rem;
            }

            .login-body {
                padding: 0.85rem 1.75rem 1.6rem;
            }
        }
    ...
    <div class="login-shell">
        <aside class="brand-panel">
            ...
            <div class="panel-copy">
                <h2>Join the team behind every Bohol trip</h2>
                <p>Create a staff account to help guests book countryside tours, Panglao escapes, island hopping, and reliable car rentals.</p>
                <ul class="spot-list">
            ...
            <div class="panel-meta">Accounts activate by email with the Staff role</div>
        </aside>
        ...
        <div class="login-card">
            <div class="login-intro">
                ...
                <p>Fill in your details. We’ll email an activation link, then activate your account with the Staff role.</p>
            </div>
            <div class="login-body">
                ...
                <?php echo form_open('register', array('autocomplete' => 'off', 'class' => 'login-form')); ?>
                    <div class="field">
                    ...
                    <div class="field">
                        ...
                        <div class="field-hint">The activation link will be sent to this address.</div>
                    </div>
        ...
        <p class="login-note">Accounts activate by email with the Staff role</p>
    </div>
