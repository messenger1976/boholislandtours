...
<head>
    ...
    <title><?php echo isset($title) ? html_escape($title) : 'Reset Password'; ?> - Bohol Island Tours</title>
    ...
    <div class="login-shell">
        <aside class="brand-panel">
            ...
            <div class="panel-copy">
                ...
                <p>Set a fresh password so you can keep managing tours, stays, and island transfers securely.</p>
                <ul class="spot-list">
        ...
        <div class="login-card">
            ...
            <div class="login-body">
                ...
                <?php echo form_open('reset-password/' . $token, array('autocomplete' => 'off', 'class' => 'login-form')); ?>
                    <div class="field">
