<style>
    ...
    .customer-edit-page .page-actions .btn {
        width: 100%;
    }

    .customer-edit-page .form-section-card {
        margin-bottom: 1rem;
    }

    .customer-edit-page .form-section-card .card-header {
        display: flex;
        align-items: center;
        gap: 0.5rem;
        font-size: 0.95rem;
    ...
    .customer-edit-page .sticky-actions {
        position: sticky;
        bottom: 0;
        z-index: 20;
    ...
    html.dark-mode .customer-edit-page .switch-box,
    body.dark-mode .customer-edit-page .switch-box {
        background: var(--surface-2, #0f172a);
        border-color: var(--card-border, #334155);
    }

    @media (min-width: 768px) {
        .customer-edit-page .page-head {
            display: flex;
        ...
        .customer-edit-page .sticky-actions .action-row {
            display: flex;
            justify-content: flex-end;
            gap: 0.65rem;
        }

        .customer-edit-page .sticky-actions .btn {
            width: auto;
            min-width: 8.5rem;
        }
    }
...
<div class="nk-block customer-edit-page">
    <div class="nk-block-head">
        <div class="page-head">
            <div class="nk-block-head-content mb-3 mb-md-0">
                <h3 class="nk-block-title page-title">
                    <i class="bi bi-pencil-square"></i> Edit Customer / Guest
                </h3>
                <div class="nk-block-des text-soft">
                    <p class="mb-0">
                        Update profile for
                        <strong><?php echo htmlspecialchars(trim($customer->first_name . ' ' . $customer->last_name), ENT_QUOTES, 'UTF-8'); ?></strong>
                        (#<?php echo (int) $customer->id; ?>)
                    </p>
                </div>
            </div>
            <div class="page-actions">
                <a href="<?php echo base_url('customers/view/' . (int) $customer->id); ?>" class="btn btn-outline-secondary">
    ...
    <?php echo form_open('customers/edit/' . $customer->id, array('id' => 'customer-edit-form', 'class' => 'customer-edit-form')); ?>
        ...
        <div class="sticky-actions">
            <div class="action-row d-grid gap-2 d-md-flex">
                <a href="<?php echo base_url('customers/view/' . (int) $customer->id); ?>" class="btn btn-secondary">Cancel</a>
